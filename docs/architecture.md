...
每个视频处理后等待 3 秒，避免触发 B站风控。

## 七、输出文件格式

转录结果保存为 TXT 文件，包含元信息头部、摘要占位符、完整原文。
...
📹 视频标题：xxx
🔗 B站链接：https://www.bilibili.com/video/BVxxxxx/
👤 作者：UP主名称
📅 发布时间：2026-06-04
⏱️  视频时长：10分30秒
📝 转录来源：B站CC字幕 / B站AI字幕 (ai-zh) / Qwen3-ASR-1.7B（CUDA加速）
⏰ 转录时间：2026-06-04 15:30:00
...
文件路径规则：`{OUTPUT_DIR}/{YYYY}/{MM}/{safe_title}_{safe_author}_{date}_{video_id}.txt`
